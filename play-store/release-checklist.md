...
- [ ] Replace the support email placeholder in `privacy.html`
...
- [ ] Run the signed AAB build
- [ ] Confirm output file exists at `android/app/build/outputs/bundle/release/app-release.aab`
- [ ] Confirm AAB is signed
